...
I am here to support you and your development. Our meetings are intended to support your growth, but you are expected to take ownership of your career development, and **these meetings should generally be led by you**. This means being thoughtful about what you want to learn, where you want to grow, and what support you need from me.

Please come prepared with a brief agenda, questions, updates, or topics you would like to discuss. Speaking up about your goals, challenges, and interests is an important part of your professional development, and these meetings are a space for you to do that. Taking ownership of the meeting helps ensure our time is focused on what matters most to you.

If you do not have anything you would like to discuss at a given meeting, it is completely fine to cancel. Just let me know as early as possible so we can both use that time effectively.

**Canceling or rescheduling meetings**

If you need to reschedule or cancel a meeting, please try your best to give 24 hours notice. While this isn't always feasible, do your best to communicate as promptly as possible.
...
Clear and respectful communication is key. When you need something, be clear about what, when, and why. When you receive an e-mail (especially one with a request), please acknowledge it and respond to the request. Here are some templates to help:
...
-   **Giving feedback**: When you do X, I interpret Y, which makes me feel Z. Therefore, I request that you ABC...
...
I use generative AI tools daily, and I'm OK with you using it too. However, I have a few expectations about how it should be used:
...
-   **Use Pitt-approved, closed tools only:** Please ONLY use University-approved tools that offer us closed / protected access. Do not use ChatGPT or other tools for any unviersity-related work in this lab. 

See also [PromptLab](https://github.com/SharptonLab/PromptLab).
...
If you are a URMP student, it is my expectation that you only report hours that you actually work, rather than submitting a blanket number of hours each week (e.g., 5 hours/week). Hours must be submitted weekly.

It is also my understanding that URMP students are not permitted to work during holiday breaks. Please plan your work and time reporting accordingly.
...
I am generally on campus Mondays and Wednesdays from 7:30 am until 3:00 pm. If my office door is open, please feel free to come in and chat! If my office door is closed, then that means that I am in another meeting. The other days of the week, I tend to work from home. Please always feel free to reach out to me via e-mail though and we can schedule something if you would like to talk.
...
I encourage you to take advantage of our flexible vacation schedule. Postdoc and staff vacation policies are linked below. For students, I recommend taking at least 3-4 weeks vacation time a year. It is important that we all take time away and detached from this work so we can recharge our batteries. I just ask that you plan early, inform me when you'll be away, and ensure your time off doesn't clash with required coursework. For detailed policies, refer to:
